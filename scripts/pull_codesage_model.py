...
DEFAULT_MODEL_ID = "codesage/codesage-base-v2"
DEFAULT_MODEL_DIR = Path(__file__).resolve().parents[1] / ".models" / "codesage-base-v2"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download the CodeSage model repo into a local model directory.",
    )
