...
Reads the ``DATABASE_URL`` from application settings so that migrations
...
# Import application settings and *all* models so that
# ``target_metadata`` includes every table.
